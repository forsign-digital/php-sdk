...
/**
 * Response for a canceled operation.
 */
class OperationCancelResponse extends BaseResponse
{
    /**
     * Gets the success status.
     *
     * @return bool Whether the operation was canceled successfully
     */
     ...
     *
     * @return \DateTime|null The cancellation date or null if not available
     */
    public function getCancellationDate(): ?\DateTime
    {
        $date = $this->getData()['cancellationDate'] ?? null;
    ...
    {
        return (string) ($this->getData()['cancellationReason'] ?? '');
    }
    
    /**
     * Gets the user who canceled the operation.
     *
     * @return string The user who canceled the operation
     */
    public function getCanceledBy(): string
    {
        return (string) ($this->getData()['canceledBy'] ?? '');
    }
}
